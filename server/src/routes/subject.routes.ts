...
import { createSubjectHandler, deleteSubjectHanlder, getAllSubjectsHandler, getSubjectByDeoartrmentHandler, getSubjectDetailsHandler, getSubjectHandler } from '../controller/subject.controller';
