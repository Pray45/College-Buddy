...
import { createSubjectHandler, deleteSubjectHanlder, getAllSubjectsHandler, getSubjectByDeoartrmentHandler, getSubjectHandler } from '../controller/subject.controller';
